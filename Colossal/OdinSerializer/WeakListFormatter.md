# Colossal.OdinSerializer.WeakListFormatter
...
```csharp
public class WeakListFormatter : Colossal.OdinSerializer.WeakBaseFormatter, Colossal.OdinSerializer.IFormatter
{
    private readonly Colossal.OdinSerializer.Serializer ElementSerializer;

    public WeakListFormatter(System.Type serializedType);
