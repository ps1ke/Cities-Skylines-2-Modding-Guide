...
```csharp
public sealed struct AircraftNavigationLane : Unity.Entities.IBufferElementData, Colossal.Serialization.Entities.ISerializable
{
    public Unity.Entities.Entity m_Lane;
    public Unity.Mathematics.float2 m_CurvePosition;
    public Game.Vehicles.AircraftLaneFlags m_Flags;
