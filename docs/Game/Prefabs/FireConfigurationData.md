...
```csharp
public sealed struct FireConfigurationData : Unity.Entities.IComponentData, Unity.Entities.IQueryTypeParameter
{
    public Unity.Entities.Entity m_FireNotificationPrefab;
    public Unity.Entities.Entity m_BurnedDownNotificationPrefab;
