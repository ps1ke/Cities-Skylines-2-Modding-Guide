...
```csharp
public sealed struct LandValueParameterData : Unity.Entities.IComponentData, Unity.Entities.IQueryTypeParameter
{
    public Unity.Entities.Entity m_LandValueInfoViewPrefab;
    ...
    public System.Single m_CommonFactorMaxBonus;
