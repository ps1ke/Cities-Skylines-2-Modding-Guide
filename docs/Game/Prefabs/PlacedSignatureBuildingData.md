...
```csharp
public sealed struct PlacedSignatureBuildingData : Unity.Entities.IComponentData, Unity.Entities.IQueryTypeParameter, Colossal.Serialization.Entities.IEmptySerializable
{
    // (no members)
}
```
