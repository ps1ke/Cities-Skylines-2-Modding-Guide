...
```csharp
public class MailBoxMode : Game.Prefabs.Modes.LocalModePrefab, Colossal.IO.AssetDatabase.IComponentBase, System.IComparable, UnityEngine.ISerializationCallbackReceiver, Colossal.IO.AssetDatabase.IPrefabBase
{
    public Game.Prefabs.Modes.MailBoxMode+ModeData[] m_ModeDatas;
...
- `Game.Prefabs.Modes.MailBoxMode+ModeData`  
