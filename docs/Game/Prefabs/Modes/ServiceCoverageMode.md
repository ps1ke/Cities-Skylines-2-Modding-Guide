...
```csharp
public class ServiceCoverageMode : Game.Prefabs.Modes.LocalModePrefab, Colossal.IO.AssetDatabase.IComponentBase, System.IComparable, UnityEngine.ISerializationCallbackReceiver, Colossal.IO.AssetDatabase.IPrefabBase
{
    public Game.Prefabs.Modes.ServiceCoverageMode+ModeData[] m_ModeDatas;
...
- `Game.Prefabs.Modes.ServiceCoverageMode+ModeData`  
