...
```csharp
public class LeisureProviderMode : Game.Prefabs.Modes.LocalModePrefab, Colossal.IO.AssetDatabase.IComponentBase, System.IComparable, UnityEngine.ISerializationCallbackReceiver, Colossal.IO.AssetDatabase.IPrefabBase
{
    public Game.Prefabs.Modes.LeisureProviderMode+ModeData[] m_ModeDatas;
...
- `Game.Prefabs.Modes.LeisureProviderMode+ModeData`  
