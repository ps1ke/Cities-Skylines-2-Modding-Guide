...
```csharp
public class SolarPoweredMode : Game.Prefabs.Modes.LocalModePrefab, Colossal.IO.AssetDatabase.IComponentBase, System.IComparable, UnityEngine.ISerializationCallbackReceiver, Colossal.IO.AssetDatabase.IPrefabBase
{
    public Game.Prefabs.Modes.SolarPoweredMode+ModeData[] m_ModeDatas;
...
- `Game.Prefabs.Modes.SolarPoweredMode+ModeData`  
