# Game.Debug.Tests.TestScenarioPerformance
...
```csharp
public class TestScenarioPerformance : Game.Debug.Tests.TestScenarioProfileBase, Colossal.TestFramework.ITestStep
{
    ...
    public TestScenarioPerformance();
