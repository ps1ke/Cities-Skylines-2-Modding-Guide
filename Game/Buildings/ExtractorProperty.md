...
```csharp
public sealed struct ExtractorProperty : Unity.Entities.IComponentData, Unity.Entities.IQueryTypeParameter, Colossal.Serialization.Entities.IEmptySerializable
{
    // (no members)
}
```
