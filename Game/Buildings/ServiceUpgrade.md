...
```csharp
public sealed struct ServiceUpgrade : Unity.Entities.IComponentData, Unity.Entities.IQueryTypeParameter, Colossal.Serialization.Entities.IEmptySerializable
{
    // (no members)
}
```
