...
```csharp
public class EditorPhotoTool : Game.UI.Editor.EditorTool, Game.UI.Editor.IEditorTool, Colossal.UI.Binding.IJsonWritable, Game.UI.Widgets.IUITagProvider
{
    public static const System.String kToolId;

    public EditorPhotoTool(Unity.Entities.World world);
