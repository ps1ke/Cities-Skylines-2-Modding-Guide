...
```csharp
public class EditorAssetImportTool : Game.UI.Editor.EditorTool, Game.UI.Editor.IEditorTool, Colossal.UI.Binding.IJsonWritable, Game.UI.Widgets.IUITagProvider
{
    public static const System.String kToolId;

    public EditorAssetImportTool(Unity.Entities.World world);
