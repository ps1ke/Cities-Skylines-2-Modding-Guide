...
```csharp
public sealed struct CarNavigationLane : Unity.Entities.IBufferElementData, Colossal.Serialization.Entities.ISerializable
{
    public Unity.Entities.Entity m_Lane;
    public Unity.Mathematics.float2 m_CurvePosition;
    public Game.Vehicles.CarLaneFlags m_Flags;
