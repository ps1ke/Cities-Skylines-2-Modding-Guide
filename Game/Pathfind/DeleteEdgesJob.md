# Game.Pathfind.ModificationJobs+DeleteEdgesJob
...
```csharp
public sealed struct DeleteEdgesJob : Unity.Jobs.IJob, Game.Pathfind.ModificationJobs+IPathfindModificationJob
{
    public Game.Pathfind.DeleteAction m_Action;
