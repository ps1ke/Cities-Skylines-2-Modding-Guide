...
```csharp
public sealed struct AirPollution : Game.Simulation.IPollution, Colossal.Serialization.Entities.IStrideSerializable, Colossal.Serialization.Entities.ISerializable
{
