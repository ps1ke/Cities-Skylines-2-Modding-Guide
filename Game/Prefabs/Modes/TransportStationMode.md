...
```csharp
public class TransportStationMode : Game.Prefabs.Modes.LocalModePrefab, Colossal.IO.AssetDatabase.IComponentBase, System.IComparable, UnityEngine.ISerializationCallbackReceiver, Colossal.IO.AssetDatabase.IPrefabBase
{
    public Game.Prefabs.Modes.TransportStationMode+ModeData[] m_ModeDatas;
...
- `Game.Prefabs.Modes.TransportStationMode+ModeData`  
