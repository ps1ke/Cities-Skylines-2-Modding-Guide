...
```csharp
public class ParkingFacilityMode : Game.Prefabs.Modes.LocalModePrefab, Colossal.IO.AssetDatabase.IComponentBase, System.IComparable, UnityEngine.ISerializationCallbackReceiver, Colossal.IO.AssetDatabase.IPrefabBase
{
    public Game.Prefabs.Modes.ParkingFacilityMode+ModeData[] m_ModeDatas;
...
- `Game.Prefabs.Modes.ParkingFacilityMode+ModeData`  
