...
```csharp
public class EmergencyGeneratorMode : Game.Prefabs.Modes.LocalModePrefab, Colossal.IO.AssetDatabase.IComponentBase, System.IComparable, UnityEngine.ISerializationCallbackReceiver, Colossal.IO.AssetDatabase.IPrefabBase
{
    public Game.Prefabs.Modes.EmergencyGeneratorMode+ModeData[] m_ModeDatas;
...
- `Game.Prefabs.Modes.EmergencyGeneratorMode+ModeData`  
