...
```csharp
public sealed struct DemandParameterData : Unity.Entities.IComponentData, Unity.Entities.IQueryTypeParameter
{
    public Unity.Entities.Entity m_ForestryPrefab;
    public Unity.Entities.Entity m_OfficePrefab;
