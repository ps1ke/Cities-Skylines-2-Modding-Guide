...
```csharp
public sealed struct WarehouseData : Unity.Entities.IComponentData, Unity.Entities.IQueryTypeParameter, Colossal.Serialization.Entities.IEmptySerializable
{
    // (no members)
}
```
