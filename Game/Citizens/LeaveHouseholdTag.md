...
```csharp
public sealed struct LeaveHouseholdTag : Unity.Entities.IComponentData, Unity.Entities.IQueryTypeParameter, Colossal.Serialization.Entities.IEmptySerializable
{
    // (no members)
}
```
